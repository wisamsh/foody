...
if (!function_exists('essb_subscribe_form_design7')) {
	function essb_subscribe_form_design7($salt, $is_widget = false, $position = '') {
		global $essb_options;
		...
		$output = '<div class="essb-subscribe-form-content essb-subscribe-from-design7'.($is_widget ? " essb-subscribe-form-inwidget" :"").'" data-position="'.$position.'">';
