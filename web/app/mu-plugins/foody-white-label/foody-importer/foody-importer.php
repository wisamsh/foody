...
if ( ! class_exists( 'WP_Importer' ) ) {
	...
	if ( file_exists( $class_wp_importer ) ) /** @noinspection PhpIncludeInspection */ {
...
function foody_importer_init() {
	...
	register_importer( 'foody', 'Foody', __( 'Import <strong>terms</strong> from a WordPress export file.', 'wordpress-importer' ), array(
		$GLOBALS['foody_import'],
		'dispatch'
	) );
}
