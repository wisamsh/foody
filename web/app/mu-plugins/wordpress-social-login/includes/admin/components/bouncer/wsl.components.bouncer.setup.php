            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    <td width="200" align="right">
                        <strong><?php _wsl_e( "Accept new registration", 'wordpress-social-login' ) ?> :</strong></td>
                    <td>
                        <select name="wsl_settings_bouncer_registration_enabled">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_registration_enabled' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_registration_enabled' ) == 2 ) {
								echo "selected";
                ...
                <tr>
                    <td width="200" align="right">
                        <strong><?php _wsl_e( "Allow authentication", 'wordpress-social-login' ) ?> :</strong></td>
                    <td>
                        <select name="wsl_settings_bouncer_authentication_enabled">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_authentication_enabled' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_authentication_enabled' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    <td width="200" align="right">
                        <strong><?php _wsl_e( "Link user account", 'wordpress-social-login' ) ?> :</strong></td>
                    <td>
                        <select name="wsl_settings_bouncer_accounts_linking_enabled">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_accounts_linking_enabled' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_accounts_linking_enabled' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
...
function wsl_component_bouncer_setup_profile_completion() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    <td width="200" align="right"><strong><?php _wsl_e( "Require E-mail", 'wordpress-social-login' ) ?>
                            :</strong></td>
                    <td>
                        <select name="wsl_settings_bouncer_profile_completion_require_email">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_profile_completion_require_email' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_profile_completion_require_email' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    <td width="200" align="right">
                        <strong><?php _wsl_e( "Allow Username change", 'wordpress-social-login' ) ?> :</strong></td>
                    <td>
                        <select name="wsl_settings_bouncer_profile_completion_change_username">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_profile_completion_change_username' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_profile_completion_change_username' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    <td width="200" align="right">
                        <strong><?php _wsl_e( "Hook extra registration fields", 'wordpress-social-login' ) ?> :</strong>
                    </td>
                    <td>
                        <select name="wsl_settings_bouncer_profile_completion_hook_extra_fields">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_profile_completion_hook_extra_fields' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_profile_completion_hook_extra_fields' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <ul style="margin-left:30px">
                ...
                <li><?php _wsl_e( '<b>E-mail Confirmation</b>: New users will need to be confirm their e-mail address before they may log in', 'wordpress-social-login' ) ?>
                    .
                </li>
                <li><?php _wsl_e( '<b>Admin Approval</b>: New users will need to be approved by an administrator before they may log in', 'wordpress-social-login' ) ?>
                    .
                </li>
            </ul>
            <p>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    <td width="200" align="right"><strong><?php _wsl_e( "User Moderation", 'wordpress-social-login' ) ?>
                            :</strong></td>
                    <td>
						<?php
                        ...
                        <select name="wsl_settings_bouncer_new_users_moderation_level">
                            <option <?php if ( $wsl_settings_bouncer_new_users_moderation_level == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "None", 'wordpress-social-login' ) ?></option>
							<?php
							foreach ( $users_moderation_level as $level => $label ) {
								?>
                                <option <?php if ( $wsl_settings_bouncer_new_users_moderation_level == $level ) {
									echo "selected";
								} ?> value="<?php echo $level; ?>"><?php _wsl_e( $label, 'wordpress-social-login' ) ?></option>
								<?php
							}
							?>
                        </select>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    <td width="200" align="right" nowrap>
                        <strong><?php _wsl_e( "New WSL users default role", 'wordpress-social-login' ) ?> :</strong>
                    </td>
                    <td>
                        <select name="wsl_settings_bouncer_new_users_membership_default_role">
                            <optgroup label="<?php _wsl_e( "Safe", 'wordpress-social-login' ) ?>:">
                                <option value="default" <?php if ( get_option( 'wsl_settings_bouncer_new_users_membership_default_role' ) == "default" ) {
									echo "selected";
								} ?> ><?php _wsl_e( "&mdash; Wordpress User Default Role &mdash;", 'wordpress-social-login' ) ?></option>
                                <option value="wslnorole" <?php if ( get_option( 'wsl_settings_bouncer_new_users_membership_default_role' ) == "wslnorole" ) {
									echo "selected";
								} ?> ><?php _wsl_e( "&mdash; No role for this site  &mdash;", 'wordpress-social-login' ) ?></option>
                            </optgroup>
                            ...
                            <optgroup label="<?php _wsl_e( "Be careful with these", 'wordpress-social-login' ) ?>:">
								...
								foreach ( $users_membership_roles as $role => $name ) {
									?>
                                    <option value="<?php echo $role ?>" <?php if ( get_option( 'wsl_settings_bouncer_new_users_membership_default_role' ) == $role ) {
										echo "selected";
									} ?> ><?php _wsl_e( $name, 'wordpress-social-login' ) ?></option>
									<?php
								}
								?>
                            </optgroup>
...
function wsl_component_bouncer_setup_filters_domains() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    <td width="200" align="right"><strong><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?>
                            :</strong></td>
                    <td>
                        <select name="wsl_settings_bouncer_new_users_restrict_domain_enabled">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_new_users_restrict_domain_enabled' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_new_users_restrict_domain_enabled' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    <td width="200" align="right" valign="top"><p>
                            <strong><?php _wsl_e( "Domains list", 'wordpress-social-login' ) ?> :</strong></p></td>
                    <td>
                        <textarea style="width:100%;height:60px;margin-top:6px;"
                                  name="wsl_settings_bouncer_new_users_restrict_domain_list"><?php echo get_option( 'wsl_settings_bouncer_new_users_restrict_domain_list' ); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td width="200" align="right" valign="top"><p>
                            <strong><?php _wsl_e( "Bounce text", 'wordpress-social-login' ) ?> :</strong></p></td>
                    <td>
						<?php
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    ...
                    <td>
                        <select name="wsl_settings_bouncer_new_users_restrict_email_enabled">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_new_users_restrict_email_enabled' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_new_users_restrict_email_enabled' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    <td width="200" align="right" valign="top"><p>
                            <strong><?php _wsl_e( "E-mails list", 'wordpress-social-login' ) ?> :</strong></p></td>
                    <td>
                        <textarea style="width:100%;height:60px;margin-top:6px;"
                                  name="wsl_settings_bouncer_new_users_restrict_email_list"><?php echo get_option( 'wsl_settings_bouncer_new_users_restrict_email_list' ); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td width="200" align="right" valign="top"><p>
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="2" style="border-top:1px solid #ccc;">
                <tr>
                    ...
                    <td>
                        <select name="wsl_settings_bouncer_new_users_restrict_profile_enabled">
                            <option <?php if ( get_option( 'wsl_settings_bouncer_new_users_restrict_profile_enabled' ) == 1 ) {
								echo "selected";
							} ?> value="1"><?php _wsl_e( "Yes", 'wordpress-social-login' ) ?></option>
                            <option <?php if ( get_option( 'wsl_settings_bouncer_new_users_restrict_profile_enabled' ) == 2 ) {
								echo "selected";
							} ?> value="2"><?php _wsl_e( "No", 'wordpress-social-login' ) ?></option>
                        </select>
                    </td>
                ...
                <tr>
                    <td width="200" align="right" valign="top"><p>
                            <strong><?php _wsl_e( "Profile urls", 'wordpress-social-login' ) ?> :</strong></p></td>
                    <td>
                        <textarea style="width:100%;height:60px;margin-top:6px;"
                                  name="wsl_settings_bouncer_new_users_restrict_profile_list"><?php echo get_option( 'wsl_settings_bouncer_new_users_restrict_profile_list' ); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td width="200" align="right" valign="top"><p>
