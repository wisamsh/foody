...
The role by default that a new user recieves is 'subscriber', however, there is a setting which allows you to define a different initial role (per sub-site) that a user recieves after registration.
