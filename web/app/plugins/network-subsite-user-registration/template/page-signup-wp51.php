...
/**
 * This is a modified version of the WordPress 5.1 wp-signup.php template
 */
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action=""><!-- nsur plugin drops the action="wp-signup.php" -->		
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	<?php
		...
		printf( __( 'Get your own %s account in seconds' ), get_site()->blogname ); //nsur changed from get_network()->site_name
	?>
	</h2>
	<form id="setupform" method="post" action="" novalidate="novalidate"><!-- nsur plugin drops the action="wp-signup.php" -->	
...
if ( 'none' === $active_signup ) {
	...
	$login_url = wp_login_url( site_url( 'local-signup' ) ); //nsur changed from network_site_url('wp-signup.php')
