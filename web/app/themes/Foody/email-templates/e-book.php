                                        ...
                                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="mcnImageContent" valign="top"
                                                    ...
                                                    <a href="https://s3-eu-west-1.amazonaws.com/foody-media/Ebook+Foody+Final+4+(WITH+LINKS)_compressed+(1).pdf" download="download">
                                ...
                                <tr>
                                    <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 10px 18px 25px;">
                                        <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0"
                                               width="100%" style="min-width: 100%;border-top: 2px solid #EEEEEE;">
                                            <tbody>
                                            <tr>
                                                <td>
                                                    <span></span>
