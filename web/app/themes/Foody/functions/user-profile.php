...
{ ?>
    ...
    <table class="form-table">
        <tr>
            <th><label for="type_of_writer">סוג כותב</label></th>
            <td>
                <?php if (get_the_author_meta('type_of_writer', $user->ID) == 'israel-cooks') { ?>
                    <select name="type_of_writer" id="type_of_writer">
                        <option value="team">נבחרת</option>
                        <option selected="selected" value="israel-cooks">בשלני ישראל</option>
                    </select><br/>
                <?php } else {
                    ?>
                    <select name="type_of_writer" id="type_of_writer">
                        <option selected="selected" value="team">נבחרת</option>
