 ...
 * Time: 7:32 PM
 */
class Foody_Accessory extends Foody_Post {

	private $foody_search;

	/**
	 * Foody_Accessory constructor.
	 *
	 * @param $accessory_post_id
	 */
	public function __construct( $post ) {
		parent::__construct( $post );

		$this->foody_search = new Foody_Search( 'foody_accessory' );
	}

	public function feed() {
		$foody_query = Foody_Query::get_instance();

		$args = $foody_query->get_query( 'foody_accessory', [ $this->id ], true );
		...
		echo '<div class="container-fluid feed-container accessory-feed-container">';
