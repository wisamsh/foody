...
class WPGO_Simple_Sitemap_Pro_Options {
	...
	public function __construct( $args ) {
		...
		), 10, 2 ); // add 'Settings' link on main Plugins page
	}
	...
	public function render_support_fields() {
		?>
        <div id="wpgo-buttons">
            <a class="button-secondary wpgo-lower" href="//wpgoplugins.com/document/simple-sitemap-pro-documentation/"
               target="_blank">Plugin Setup</a>
            <a class="button-secondary wpgo-lower" href="//wpgoplugins.com/premium-plugin-support/" target="_blank">Premium
                Support</a>
            <a style="padding-left:4px;padding-right:4px;" class="button-secondary wpgo-lower"
               href="https://twitter.com/wpgoplugins" target="_blank"><span style="padding-top:3px;color:#55acee;"
                                                                            class="dashicons dashicons-twitter"
                                                                            title="Join us on Twitter!"></span></a>
            <a style="padding-left:4px;padding-right:4px;" class="button-secondary wpgo-lower"
               href="https://www.facebook.com/WPGO-Plugins-555709481298765" target="_blank"><span
                        style="padding-top:3px;color:#3b5998;" class="dashicons dashicons-facebook"
                        title="Join us on Facebook!"></span></a>
        </div>
		<?php
	}
	...
	public function render_myaccount_fields() {
        ...
        <div id="wpgo-myaccount-btn">
            <a class="button-secondary wpgo-lower" href="//wpgoplugins.com/my-account" target="_blank">Go To My
                Account</a>
            <p class="description">Access your wpgoplugins.com account page to view purchased items, view/renew license
                keys, download products, and update profile settings.</p>
        </div>
		<?php
	}
        ...
        <div class="wrap">
			...
			if ( isset( $_POST['reset_options'] ) ) :
                ...
                <div id="setting-error-settings_updated" class="updated settings-error notice is-dismissible">
                    <p><strong><?php echo 'Settings reset.'; ?></strong></p>
            ...
            <form id="plugin-options-form" method="post" action="options.php">
                ...
                <div class="simple-sitemap-pro-tab tab-content">
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                <p>The Simple Sitemap Pro plugin includes two shortcodes with many attributes available
                                    to customize the output of your sitemap.</p>
                                <p><strong>TIP: If you haven't used the plugin before start by entering <code>[simple-sitemap]</code>
                                        into any post/page without any attributes. Then, add attributes as necessary
                                        until you get the required results.</strong></p>

                                <br><label><input
                                            name="<?php echo $this->_args['options_db_name']; ?>[chk_parent_page_link]"
                                            type="checkbox"
                                            value="1" <?php if ( isset( $options['chk_parent_page_link'] ) ) {
										checked( '1', $options['chk_parent_page_link'] );
									} ?>> Remove parent page links?</label><br><br>

                                <input type="text" class="exclude regular-text code"
                                       name="<?php echo $this->_args['options_db_name']; ?>[txt_exclude_parent_pages]"
                                       value="<?php echo $options['txt_exclude_parent_pages']; ?>">
                                <p class="description">Enter comma separated list of parent page IDs to remove specific
                                    links. Leave blank to remove ALL parent page links.</p><br>
                                ...
                                <div style="background:#fff;border: 1px dashed #ccc;padding: 15px;padding-top:5px;">
                                    ...
                                    <p>Use this shortcode to display a sitemap of different post types. Note: Using this
                                        shortcode with no attributes outputs a list of posts for each post type: <code>[simple-sitemap]</code>
                                    </p>

                                    <p>There are many attributes you can use to customize the look of your sitemap.
                                        Attributes can be combined as required for an even more flexible sitemap
                                        layout.</p>

                                    <ol style="line-height:22px;">
                                        <li>Render the sitemap in a tabbed layout. Each tab contains a separate post
                                            type:
                                        ...
                                        <li>Order posts for each post type via title, date, author, ID, menu_order etc.
                                            See full list of options <a
                                                    href="https://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters"
                                                    target="_blank">here</a>: <code>[simple-sitemap
                                                orderby='title']</code></li>
                                        <li>Whatever the 'orderby' attribute is set to the 'order' attribute will sort
                                            them in either ascending or descending:
                                        ...
                                        <li>Display the post featured image (if defined) next to each sitemap item as an
                                            icon:
                                        ...
                                        <li>If multiple tabbed sitemaps are to be displayed then this attribute is
                                            useful to avoid CSS id conflicts:
                                            <code>[simple-sitemap id='999']</code></li>
                                        <li>The sitemap can now also be show as a continuous horizontal list (separate
                                            list for each post type):
                                            <code>[simple-sitemap horizontal='true']</code><br><b>Note: For this to work
                                                the <code>render</code> attribute needs to be empty (which it is by
                                                default)</b>.
                                        </li>
                                        <li>You can customize the horizontal list separator too:
                                            <code>[simple-sitemap horizontal='true' horizontal_separator=' |
                                                ']</code><br><b>Note: For this to work the <code>horizontal</code>
                                                attribute needs to be set to true</b>.
                                        </li>
                                        <li>Optionally set each sitemap link to 'nofollow': <code>[simple-sitemap
                                                nofollow="1"]</code></li>
                                        <li>Display only public posts/pages: <code>[simple-sitemap
                                                visibility="public"]</code></li>
                                    </ol>

                                    Here's a full list of attributes for the [simple-sitemap] shortcode with default
                                    values:
                                    <ul>
                                        ...
                                        <li><code>horizontal_separator=', '</code> (note the space, if required in
                                            outputted horizontal list)
                                        </li>
                                ...
                                <div style="background:#fff;border: 1px dashed #ccc;padding: 15px;padding-top:5px;margin-top:15px;">
                                    ...
                                    <p>Use this shortcode to display a sitemap for a single post type showing posts
                                        grouped by taxonomy terms. Note: Using this shortcode with no attributes outputs
                                        a list of posts grouped by taxonomy: <code>[foody-simple-sitemap-group]</code>
                                    </p>
                                    ...
                                    <ol style="line-height:22px;">
                                        ...
                                        <li>Order posts for each post type via title, date, author, ID, menu_order etc.
                                            See full list of options <a
                                                    href="https://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters"
                                                    target="_blank">here</a>: <code>[foody-simple-sitemap-group
                                                orderby='title']</code></li>
                                        <li>Whatever the 'orderby' attribute is set to the 'order' attribute will sort
                                            them in either ascending or descending:
                                        ...
                                        <li>Whatever the 'term_orderby' attribute is set to the 'term_order' attribute
                                            will sort them in either ascending or descending:
                                            <code>[foody-simple-sitemap-group term_order='asc|desc']</code></li>
                                        <li>Comma separated list of taxonomy terms (e.g. categories) to exclude from the
                                            sitemap:
                                            <code>[foody-simple-sitemap-group exclude_terms="term1, term2"]</code></li>
                                        <li>Comma separated list of taxonomy terms (e.g. categories) to include in the
                                            sitemap:
                                        ...
                                        <li>Optionally set each sitemap link to 'nofollow': <code>[foody-simple-sitemap-group
                                                nofollow="1"]</code></li>
                                        <li>Display only public posts/pages: <code>[simple-sitemap
                                                visibility="public"]</code></li>
                                    </ol>

                                    Here's a full list of attributes for the [foody-simple-sitemap-group] shortcode with
                                    default values:
                                    <ul>
                                ...
                                <div style="background:#fff;border: 1px dashed #ccc;padding: 15px;padding-top:5px;margin-top:15px;">
                                    ...
                                    <p>Use this shortcode to display all the child pages of a specific parent page.
                                        <code>[simple-sitemap-child]</code></p>

                                    <p>This shortcode is basically a wrapper for the <a
                                                href="https://developer.wordpress.org/reference/functions/wp_list_pages/"
                                                target="_blank"><code>wp_list_pages()</code></a> WordPress function. So,
                                        you can use any parameter of that function as a shortcode attribute to control
                                        sitemap output.</p>

                                    <p>You can optionally output the parent page too via the <code>title_li</code>
                                        attribute. By default, if you don't add this attribute, the parent parent page
                                        link will be included in the list of pages. You can also specify a custom label
                                        (which won't be a link).</p>

                                    <br>
                                    <p><code>[simple-sitemap-child]</code> or <code>[simple-sitemap-child
                                            title_li=""]</code> (parent page will NOT be included in the list of pages)
                                    </p>

                                    <br>
                                    <p><code>[simple-sitemap-child title_li="@"]</code> (includes the parent page link
                                        in the list of pages)</p>

                                    <br>
                                    <p><code>[simple-sitemap-child title_li="Parent Page"]</code> (will show the text
                                        "Parent Page" as the parent label)</p>

                                    <br>
                                    <p>Optionally set each sitemap link to 'nofollow': <code>[simple-sitemap-child
                                            nofollow="1"]</code></p>

                                    <br>
                                    <p>If you want to show the parent page label <strong>but not as part of the
                                            list</strong> then leave out the <code>title_li</code> attribute, and
                                        manually add the label outside of the shortcode.</p>
                                </div>

                                <div style="background:#fff;border: 1px dashed #ccc;padding: 15px;padding-top:5px;margin-top:15px;">
                                    <h2><?php _e( '[foody-simple-sitemap-tax] shortcode', 'simple-sitemap' ); ?></h2>

                                    <p>Use this shortcode to display a list of post taxonomies (e.g. categories). Any
                                        publicly registered taxonomy can be listed using this shortcode. Note: Using
                                        this shortcode with no attributes outputs a list of post categories.</p>

                                    <p>There are many attributes you can use with this shortcode. Attributes can be
                                        combined as required for an even more flexible sitemap layout.</p>

                                    <p>Here's the full list of attributes for the
                                        <code>[foody-simple-sitemap-tax]</code> shortcode with default values:</p>
                                    <ul>
                                    ...
                                    <p>As this shortcode implements the <code>wp_list_categories()</code> function
                                        internally, the attributes match the function arguments closely. Please see the
                                        <a href="https://developer.wordpress.org/reference/functions/wp_list_categories/"
                                           target="_blank">function documentation</a> for more information about each
                                        attribute.</p>
                                </div>
                                ...
                                <div style="background:#fff;border: 1px dashed #ccc;padding: 15px;padding-top:5px;margin-top:15px;">
                                    ...
                                    <p>Here's a list of attributes for the <code>[simple-sitemap-menu]</code> shortcode
                                        with default values:</p>
                                    <ul>
                                        <li><code>menu='[name of menu, or menu ID, slug, object]'</code> e.g. <code>menu='Main
                                                Menu'</code></li>
                                    </ul>
                                    <p>This shortcode implements the <code>wp_nav_menu()</code> function internally, and
                                        the attributes match the function arguments closely. See the <a
                                                href="https://developer.wordpress.org/reference/functions/wp_nav_menu/"
                                                target="_blank">function documentation</a> for more information about
                                        each attribute.</p>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr valign="top" style="display:none;">
                            ...
                            <td>
                                <textarea name="<?php echo $this->_args['options_db_name']; ?>[txtar_sitemap_script]"
                                          rows="7" cols="50"
                                          type='textarea'><?php echo $options['txtar_sitemap_script']; ?></textarea>
            ...
            <form action="<?php echo self::currURL(); // current page url ?>" method="post"
                  id="simple-sitemap-pro-reset-form" style="display:inline;">
