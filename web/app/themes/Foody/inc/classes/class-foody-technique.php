 ...
 * Time: 7:32 PM
 */
class Foody_Technique extends Foody_Post {
	...
	public function __construct( $post ) {
		...
		$this->foody_search = new Foody_Search( 'foody_technique' );
	}

	public function feed() {
		$foody_query = Foody_Query::get_instance();

		$args = $foody_query->get_query( 'foody_technique', [ $this->id ], true );
