...
if (!function_exists('essb_subscribe_form_design4')) {
	function essb_subscribe_form_design4($salt, $is_widget = false, $position = '') {
		global $essb_options;
		...
		if ($subscribe_mc_imagealign3 == '' || $subscribe_mc_imagealign3 == 'left') {
			...
			$output .= '<input class="submit" name="submit" type="submit" value="'.$subscribe_mc_button.'" onclick="essb.ajax_subscribe(\''.$salt.'\', event);">';
			$output .= '</form>';
		...
		if ($subscribe_mc_imagealign3 == 'right') {
			...
			$output .= '<input class="submit" name="submit" type="submit" value="'.$subscribe_mc_button.'" onclick="essb.ajax_subscribe(\''.$salt.'\');">';
			$output .= '</form>';
