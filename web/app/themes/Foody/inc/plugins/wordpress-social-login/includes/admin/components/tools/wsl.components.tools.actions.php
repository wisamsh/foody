    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <a class="button-primary"
               href="<?php echo wp_nonce_url( 'options-general.php?page=wordpress-social-login&wslp=auth-paly' ); ?>"><?php _wsl_e( "Go to the authentication playground", 'wordpress-social-login' ) ?></a>
        </div>
    </div>
	<?php
}
...
function wsl_component_tools_diagnostics() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <a class="button-primary"
               href="<?php echo wp_nonce_url( 'options-general.php?page=wordpress-social-login&wslp=tools&do=diagnostics' ); ?>"><?php _wsl_e( "Run WordPress Social Login Diagnostics", 'wordpress-social-login' ) ?></a>
        </div>
    </div>
	<?php
}
...
function wsl_component_tools_system_information() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <a class="button-primary"
               href="<?php echo wp_nonce_url( 'options-general.php?page=wordpress-social-login&wslp=tools&do=sysinfo' ); ?>"><?php _wsl_e( "Display your system information", 'wordpress-social-login' ) ?></a>
        </div>
    </div>
	<?php
}
...
function wsl_component_tools_repair_wsl_tables() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <a class="button-primary"
               href="<?php echo wp_nonce_url( 'options-general.php?page=wordpress-social-login&wslp=tools&do=repair' ); ?>"><?php _wsl_e( "Repair WordPress Social Login databases tables", 'wordpress-social-login' ) ?></a>
        </div>
    </div>
	<?php
}
        ...
        <div class="inside">
            ...
            <form method="post" id="wsl_setup_form" action="options.php">
                ...
                <select name="wsl_settings_debug_mode_enabled">
                    <option <?php if ( ! $wsl_settings_debug_mode_enabled ) {
						echo "selected";
					} ?> value="0"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
                    <option <?php if ( $wsl_settings_debug_mode_enabled == 1 ) {
						echo "selected";
					} ?> value="1"><?php _wsl_e( "Enabled &mdash; Log actions in a file", 'wordpress-social-login' ) ?></option>
                    <option <?php if ( $wsl_settings_debug_mode_enabled == 2 ) {
						echo "selected";
					} ?> value="2"><?php _wsl_e( "Enabled &mdash; Log actions to database", 'wordpress-social-login' ) ?></option>
                </select>
				...
				<?php if ( $wsl_settings_debug_mode_enabled ): ?>
                    <a class="button-secondary"
                       href="options-general.php?page=wordpress-social-login&wslp=watchdog"><?php _wsl_e( 'View WSL logs', 'wordpress-social-login' ) ?></a>
				<?php endif; ?>
            </form>
        </div>
    </div>
...
function wsl_component_tools_development_mode() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <form method="post" id="wsl_setup_form" action="options.php"
			      <?php if ( ! $wsl_settings_development_mode_enabled ) { ?>onsubmit="return confirm('Do you really want to enable Development Mode?\n\nPlease confirm that you have read and understood the abovementioned by clicking OK.');"<?php } ?>>
				<?php settings_fields( 'wsl-settings-group-development' ); ?>

                <select name="wsl_settings_development_mode_enabled">
                    <option <?php if ( ! $wsl_settings_development_mode_enabled ) {
						echo "selected";
					} ?> value="0"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
                    <option <?php if ( $wsl_settings_development_mode_enabled ) {
						echo "selected";
					} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                </select>
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <a class="button-danger"
               href="<?php echo wp_nonce_url( 'options-general.php?page=wordpress-social-login&wslp=tools&do=uninstall' ); ?>"
