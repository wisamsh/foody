...
function wsl_render_comment_form() {
	wsl_deprecated_function( __FUNCTION__, '2.2.3' );
	wsl_action_wordpress_social_login();
}
...
function wsl_shortcode_handler() {
	...
	return wsl_shortcode_wordpress_social_login();
}
...
function wsl_user_custom_avatar( $avatar, $mixed, $size, $default, $alt ) {
	...
	return wsl_get_wp_user_custom_avatar( $html, $mixed, $size, $default, $alt );
}

function wsl_bp_user_custom_avatar( $html, $args ) {
	wsl_deprecated_function( __FUNCTION__, '2.2.3' );

	return wsl_get_bp_user_custom_avatar( $html, $args );
}
