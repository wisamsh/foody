...
function wsl_component_contacts_settings_setup_google() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <hr/>
            <select name="wsl_settings_contacts_import_google" <?php if ( ! get_option( 'wsl_settings_Google_enabled' ) )
				echo "disabled" ?> >
                <option <?php if ( get_option( 'wsl_settings_contacts_import_google' ) == 1 ) {
					echo "selected";
				} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                <option <?php if ( get_option( 'wsl_settings_contacts_import_google' ) == 2 ) {
					echo "selected";
				} ?> value="2"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
            </select>
        </div>
    </div>
	<?php
...
function wsl_component_contacts_settings_setup_facebook() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <hr/>
            <select name="wsl_settings_contacts_import_facebook" <?php if ( ! get_option( 'wsl_settings_Facebook_enabled' ) )
				echo "disabled" ?> >
                <option <?php if ( get_option( 'wsl_settings_contacts_import_facebook' ) == 1 ) {
					echo "selected";
				} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                <option <?php if ( get_option( 'wsl_settings_contacts_import_facebook' ) == 2 ) {
					echo "selected";
				} ?> value="2"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
            </select>
        </div>
...
function wsl_component_contacts_settings_setup_twitter() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <hr/>
            <select name="wsl_settings_contacts_import_twitter" <?php if ( ! get_option( 'wsl_settings_Twitter_enabled' ) )
				echo "disabled" ?> >
                <option <?php if ( get_option( 'wsl_settings_contacts_import_twitter' ) == 1 ) {
					echo "selected";
				} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                <option <?php if ( get_option( 'wsl_settings_contacts_import_twitter' ) == 2 ) {
					echo "selected";
				} ?> value="2"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
            </select>
        </div>
...
function wsl_component_contacts_settings_setup_linkedin() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            ...
            <hr/>
            <select name="wsl_settings_contacts_import_linkedin" <?php if ( ! get_option( 'wsl_settings_LinkedIn_enabled' ) )
				echo "disabled" ?> >
                <option <?php if ( get_option( 'wsl_settings_contacts_import_linkedin' ) == 1 ) {
					echo "selected";
				} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                <option <?php if ( get_option( 'wsl_settings_contacts_import_linkedin' ) == 2 ) {
					echo "selected";
				} ?> value="2"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
            </select>
        </div>
...
function wsl_component_contacts_settings_setup_live() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            <hr/>
            <select name="wsl_settings_contacts_import_live" <?php if ( ! get_option( 'wsl_settings_Live_enabled' ) )
				echo "disabled" ?> >
                <option <?php if ( get_option( 'wsl_settings_contacts_import_live' ) == 1 ) {
					echo "selected";
				} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                <option <?php if ( get_option( 'wsl_settings_contacts_import_live' ) == 2 ) {
					echo "selected";
				} ?> value="2"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
            </select>
        </div>
...
function wsl_component_contacts_settings_setup_vkontakte() {
    ...
    <div class="stuffbox">
        ...
        <div class="inside">
            <hr/>
            <select name="wsl_settings_contacts_import_vkontakte" <?php if ( ! get_option( 'wsl_settings_Vkontakte_enabled' ) )
				echo "disabled" ?> >
                <option <?php if ( get_option( 'wsl_settings_contacts_import_vkontakte' ) == 1 ) {
					echo "selected";
				} ?> value="1"><?php _wsl_e( "Enabled", 'wordpress-social-login' ) ?></option>
                <option <?php if ( get_option( 'wsl_settings_contacts_import_vkontakte' ) == 2 ) {
					echo "selected";
				} ?> value="2"><?php _wsl_e( "Disabled", 'wordpress-social-login' ) ?></option>
            </select>
        </div>
