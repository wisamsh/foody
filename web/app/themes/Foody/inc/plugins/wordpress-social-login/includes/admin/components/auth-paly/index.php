		...
		<?php else: ?>
                ...
                <div class="inside">
                    <table class="wp-list-table widefat">
						...
						<?php if ( isset( $adapter->openidIdentifier ) ): ?>
                            <tr>
                                <th width="200">
                                    <label><?php _wsl_e( "OpenID Identifier", 'wordpress-social-login' ) ?></label></th>
						...
						<?php if ( isset( $adapter->config['keys'] ) ): ?>
                            <tr>
                                <th width="200">
                                    <label><?php _wsl_e( "Application keys", 'wordpress-social-login' ) ?></label></th>
                                <td>
                                    <div style="max-width:650px"><?php echo json_encode( $adapter->config['keys'] ); ?></div>
                                </td>
                            </tr>
						<?php endif; ?>
						...
						<?php if ( $adapter->token( "access_token" ) ): ?>
                            <tr>
                                <th width="200">
                                    <label><?php _wsl_e( "Access token", 'wordpress-social-login' ) ?></label></th>
                                <td>
                                    <div style="max-width:650px"><?php echo $adapter->token( "access_token" ); ?></div>
                                </td>
                            </tr>
						<?php endif; ?>
						...
						<?php if ( $adapter->token( "access_token_secret" ) ): ?>
                            <tr>
                                <th width="200">
                                    <label><?php _wsl_e( "Access token secret", 'wordpress-social-login' ) ?></label>
                                </th>
						...
						<?php if ( $adapter->token( "expires_in" ) ): ?>
                            <tr>
                                <th width="200">
                                    <label><?php _wsl_e( "Access token expires in", 'wordpress-social-login' ) ?></label>
                                </th>
						...
						<?php if ( $adapter->token( "expires_at" ) ): ?>
                            <tr>
                                <th width="200">
                                    <label><?php _wsl_e( "Access token expires at", 'wordpress-social-login' ) ?></label>
                                </th>
			...
			if ( ! isset( $adapter->openidIdentifier ) ):
                    ...
                    <div class="inside">
                        ...
                        <table class="wp-list-table widefat">
                            <tr>
                                ...
                                <td><input type="text" style="width:96%" name="console-path"
                                           value="<?php echo htmlentities( $path ); ?>"><a
                                            href="https://apigee.com/providers" target="_blank"><img
                                                src="<?php echo $assets_base_url . 'question.png' ?>"
                                                style="vertical-align: text-top;"/></a></td>
                            </tr>
                            <tr>
                                <th width="200"><label><?php _wsl_e( "Method", 'wordpress-social-login' ) ?></label>
                                </th>
                                <td><select style="width:100px" name="console-method">
                                        <option value="GET" <?php if ( $method == 'GET' ) {
											echo 'selected';
										} ?>>GET
                                        </option><!-- <option value="POST" <?php if ( $method == 'POST' ) {
											echo 'selected';
										} ?>>POST</option>--></select></td>
                            </tr>
                            <tr>
                                <th width="200"><label><?php _wsl_e( "Query", 'wordpress-social-login' ) ?></label></th>
                                <td><textarea style="width:100%;height:60px;margin-top:6px;"
                                              name="console-query"><?php echo htmlentities( $query ); ?></textarea></td>
                            </tr>
                        </table>

                        <br/>

                        <input type="submit" value="<?php _wsl_e( "Submit", 'wordpress-social-login' ) ?>"
                               class="button">
                        </form>
                    </div>
                </div>
                ...
                <div class="stuffbox">
                    ...
                    <div class="inside">
                        <textarea rows="25" cols="70" wrap="off"
                                  style="width:100%;height:400px;margin-bottom:15px;font-family: monospace;font-size: 12px;"><?php echo htmlentities( print_r( $response, true ) ); ?></textarea>
                    </div>
                </div>
				<?php if ( 0 ): ?>
                    <div class="stuffbox">
                        ...
                        <div class="inside">
<textarea rows="25" cols="70" wrap="off"
          style="width:100%;height:210px;margin-bottom:15px;font-family: monospace;font-size: 12px;"
...
catch( Exception $e )
{
    echo "Ooophs, we got an error: " . $e->getMessage();
                    ...
                    <div class="stuffbox">
                        ...
                        <div class="inside">
                            <textarea rows="25" cols="70" wrap="off"
                                      style="width:100%;height:400px;margin-bottom:15px;font-family: monospace;font-size: 12px;"><?php echo htmlentities( print_r( $adapter, true ) ); ?></textarea>
                        </div>
                    </div>
                    <div class="stuffbox">
                        <h3>
                        ...
                        <div class="inside">
                            <textarea rows="25" cols="70" wrap="off"
                                      style="width:100%;height:350px;margin-bottom:15px;font-family: monospace;font-size: 12px;"><?php echo htmlentities( print_r( $_SESSION, true ) ); ?></textarea>
                        </div>
                    </div>
				<?php endif; ?>
			<?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										if ( isset( $user_profile[ $item['field'] ] ) && $user_profile[ $item['field'] ] ) {
											...
											if ( in_array( strtolower( $item['field'] ), array(
												'profileurl',
												'websiteurl',
												'email'
											) ) ) {
												...
												?>
                                                <a href="<?php echo $field_value; ?>" target="_blank"><img width="36"
                                                                                                           height="36"
                                                                                                           align="left"
...
<div class="postbox">
                    < div class="inside">
                              ...
                              < div style="width: 380px; padding: 10px; border: 1px solid #ddd; background-color: #fff;"> <?php do_action( 'wordpress_social_login', array( 'mode' => 'test', 'caption' => '' ) ); ?> </div >
                                                                                                                                                                                                                        </div >
                                                                                                                                                                                                                          </div >
                                                                                                                                                                                                                            </div >
                                                                                                                                                                                                                              </td >
