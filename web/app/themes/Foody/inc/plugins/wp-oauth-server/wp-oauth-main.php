...
class WO_Server {
	...
	function __construct() {
		...
		if ( ! defined( 'WOCHECKSUM' ) ) {
			define( 'WOCHECKSUM', '8694E0EB604E9EC76943B0ABF4245419' );
		}
	...
	public function install() {
		...
		/**
		 * SET ACTIVATION TIME OF THE PLUGIN
		 *
		 * Since there are keys generated on activation and not just per plugin version, we should track public and
		 * private keys using a basic time stamp.
		 *
		 * This option is specific to the public and private keys generated. In the future this will be moved to
		 * individual clients when they are created. Clients will have the ability to generate their own keys.
		 *
		 * @since 3.7.4
		 */
