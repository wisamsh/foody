...
use WPOAuth2\Storage\AccessTokenInterface as AccessTokenStorageInterface;
use WPOAuth2\Storage\RefreshTokenInterface;
...
class AccessToken implements AccessTokenInterface {
	...
	public function createAccessToken( $client_id, $user_id, $scope = null, $includeRefreshToken = true ) {
		...
		//print_r(current_time( 'timestamp' ) + $this->config['access_lifetime']); exit;

		$this->tokenStorage->setAccessToken( $token["access_token"], $client_id, $user_id, $this->config['access_lifetime'] ? ( current_time( 'timestamp' ) + $this->config['access_lifetime'] ) : null, $scope );
