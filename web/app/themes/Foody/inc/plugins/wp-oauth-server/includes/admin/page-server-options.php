                ...
                <form method="post" action="options.php">
                    ...
                    <div id="wo_tabs">
                        ...
                        <div id="general-settings">
                            ...
                            <table class="form-table wp-oauth-form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        Block Unauthenticated Requests to the REST API
                                    </td>
                                </tr>
                        ...
                        <div id="advanced-configuration">
                            ...
                            <p>
                                Control which Grant Types that the server will accept. As of version 3.8.0, grant type
                                are controlled at the client level.
                            </p>
