...
$disclaimer = __(
    "הערכים התזונתיים המופיעים במתכון חושבו על פי חומרי הגלם הספציפיים המופיעים במתכון המקורי וכל שינוי באופן הכנה, בסוג המוצר ו/או וחברת המצרך ו/או כמויות שונות יוביל לשינוי הערכים.
...
<div class="nutrition-container <?php echo $is_odd ? 'odd-nutritions' : '' ?>">
    <h2 class="title">
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Playlist-Page" transform="translate(-739.000000, -3712.000000)" fill="#E6392B" fill-rule="nonzero"
               stroke="#E6392B" stroke-width="0.799999952">
