			...
			<script>
				function handleChange(checkbox) {
					if (checkbox.checked == true) {
						document.getElementById("register_btn_ebook").removeAttribute("disabled");
					} else {
						document.getElementById("register_btn_ebook").setAttribute("disabled", "disabled");
					}
				}
			</script>
			<div class="md-checkbox col-12" id="content-app">
				<input id="check-e-book" type="checkbox" checked name="e-book" class="ebook_checker" onchange='handleChange(this);'>
