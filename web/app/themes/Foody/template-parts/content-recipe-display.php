...
<script async defer type="application/ld+json" id="recipe-schema">
     {
          ...
          if ($aggregateRating != false) { ?> "aggregateRating": <?php echo $aggregateRating; ?>,
          <?php } ?> "name": "<?php echo addslashes(get_the_title()) ?>",
          "nutrition": <?php echo $recipe->get_jsonld_nutrients() ?>,
...
<?php if (function_exists("footabc_add_code_to_content") && get_current_blog_id() == 2) {
     echo footabc_add_code_to_content();
} ?>
