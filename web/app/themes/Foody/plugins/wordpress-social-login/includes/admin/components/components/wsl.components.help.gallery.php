...
function wsl_component_components_gallery() {
	...
	$response = wp_remote_get( 'http://miled.github.io/wordpress-social-login/components-' . wsl_get_version() . '.json', array( 'timeout'   => 15,
	                                                                                                                             'sslverify' => false
	) );
	...
	if ( ! is_wp_error( $response ) ) {
		...
		if ( $components ) {
            ...
            <p><?php _wsl_e( "These components and add-ons can extend the functionality of WordPress Social Login", 'wordpress-social-login' ) ?>
                .</p>
			...
			foreach ( $components as $item ) {
                ...
                <div class="wsl_component_div">
                    ...
                    <a class="button button-secondary" href="<?php echo $item['download_link']; ?>"
                       target="_blank"><?php _wsl_e( "Get this Component", 'wordpress-social-login' ) ?></a>
                </div>
				<?php
			}
			?>
            ...
            <div class="wsl_component_div">
                ...
                <a class="button button-primary" href="http://miled.github.io/wordpress-social-login/documentation.html"
                   target="_blank"><?php _wsl_e( "WSL Developer API", 'wordpress-social-login' ) ?></a>
                <a class="button button-secondary"
                   href="http://miled.github.io/wordpress-social-login/submit-component.html"
                   target="_blank"><?php _wsl_e( "Submit your WSL Component", 'wordpress-social-login' ) ?></a>
            </div>
