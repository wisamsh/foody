	...
	function wsl_render_error_page( $message, $notes = null, $provider = null, $api_error = null, $php_exception = null ) {
        ...
        <head>
            ...
            <title><?php bloginfo( 'name' ); ?>
                - <?php _wsl_e( "Oops! We ran into an issue", 'wordpress-social-login' ) ?>.</title>
            <style type="text/css">
                body {
                    background: #f1f1f1;
                }
        ...
        <div id="error-page">
            <table width="100%" border="0">
                ...
                <tr>
                    <td align="center"><h4><?php _wsl_e( "Oops! We ran into an issue", 'wordpress-social-login' ) ?>
                            .</h4></td>
                </tr>
                ...
                <tr>
                    <td>
                        <p style="padding: 0;">
                            <a href="javascript:xi();"
                               style="float:right"><?php _wsl_e( "Details", 'wordpress-social-login' ) ?></a>
                            <a href="<?php echo home_url(); ?>"
                               style="float:left">&xlarr; <?php _wsl_e( "Back to home", 'wordpress-social-login' ) ?></a>
                        </p>
